        ...
        <div className={Style}>
            <div className='bodyQs pt-5'>
                ...
                <div className='position-relative section__nossos-propositos'>
                    <div className='position-absolute section__nossos-propositos-list rounded-start-4 end-0 text-white py-5 px-md-5'>
                        <ul className='list__nossos-propositos px-4 px-md-5'>
                            ...
                            <li className='d-md-flex pb-4'>
                                ...
                                <p className='px-md-5 fs-4'>Ser referência na recuperação ambiental e no apoio às comunidades, contribuindo para um futuro sustentável onde a natureza e as populações locais coexistam.</p>
                            </li>
                            <li className='d-md-flex'>
                                <h3>Nossos <br />valores</h3>
                                <ul className='px-md-5 w-75 fs-4'>
                                    <li>Solidariedade;</li>
                                    <li>Empatia;</li>
                                    <li>Transparência.</li>
                                </ul>
                    ...
                    <div className='section-title__nossos-propositos rounded-end-4 d-md-flex align-items-center'>
                        <h2 className='title__nossos-propositos ps-4 pt-5 pt-md-0 px-md-5'>Nossos <br />propósitos</h2>
                    </div>
                </div>
            </div>
        </div>
